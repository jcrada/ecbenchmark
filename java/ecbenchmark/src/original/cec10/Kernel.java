...
public final class Kernel {
   ...
   */
  public final static void multiply(final double[] vec, final double[] mat,
      final double[] dest) {
   ...
   * @return the result
   */
 public  static final double shiftedSphere(final double[] x, final double[] o,
   ...
   * @return the result
   */
  public static final double shiftedPermSphere(final double[] x,
   ...
   * @return the table
   */
 public  static final double[] createPowLookup(final int count) {
    int i;
    final double[] d;
    final double pow;
   ...
   * @return the result
   */
 public  static final double shiftedElliptic(final double[] x, final double[] o,
   ...
   * @return the result
   */
 public  static final double shiftedPermElliptic(final double[] x,
      final double[] o, final int[] P, final int start, final int count,
      final double[] lookup) {
    int i, j, k;
    // final double pow;
   ...
   * @return the result
   */
 public  static final double shiftedPermRotElliptic(final double[] x,
   ...
   * @return the result
   */
 public  static final double shiftedRastrigin(final double[] x, final double[] o,
      final int start, final int count) {
    int j;
    double s, z;
   ...
   * @return the result
   */
 public  static final double shiftedPermRastrigin(final double[] x,
      final double[] o, final int[] P, final int start, final int count) {
    int j, k;
    double s, z;
   ...
   * @return the result
   */
 public  static final double shiftedPermRotRastrigin(final double[] x,
      final double[] o, final int[] P, final double[] M, final int start,
   ...
   * @return the result
   */
  public static final double shiftedAckley(final double[] x, final double[] o,
      final int start, final int count) {
    int j;
    double s1, s2, z;
   ...
   * @return the result
   */
  public static final double shiftedPermAckley(final double[] x,
      final double[] o, final int[] P, final int start, final int count) {
    int j, k;
    double s1, s2, z;
   ...
   * @return the result
   */
  public static final double shiftedPermRotAckley(final double[] x,
      final double[] o, final int[] P, final double[] M, final int start,
      final int count, final double[] z) {
    final int upper, max;
    int i, j, k;
   ...
   * @return the result
   */
  public static final double shiftedSchwefel12(final double[] x,
   ...
   * @return the result
   */
 public  static final double shiftedPermSchwefel12(final double[] x,
      final double[] o, final int[] P, final int start, final int count) {
    int j, k;
    final int end;
    double s1, s2, z;
   ...
   * @return the result
   */
 public  static final double shiftedRosenbrock(final double[] x,
      final double[] o, final int start, final int count) {
    int j;
    double s, z, oz, t;
   ...
   * @return the result
   */
 public  static final double shiftedPermRosenbrock(final double[] x,
      final double[] o, final int[] P, final int start, final int count) {
    int j, k;
    double s, z, oz, t;
